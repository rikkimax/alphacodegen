...
module alphacodegen.pregen2.pegged_markdown;
...
struct GenericMarkdown(TParseTree)
{
    ...
    static this()
    {
        ...
        rules["PipeTable"] = toDelegate(&PipeTable);
        rules["PipeTableHeader"] = toDelegate(&PipeTableHeader);
        rules["PipeTableHeaderItem"] = toDelegate(&PipeTableHeaderItem);
        rules["PipeTableSeperator"] = toDelegate(&PipeTableSeperator);
        rules["PipeTableEntry"] = toDelegate(&PipeTableEntry);
        rules["PipeTableEntryCell"] = toDelegate(&PipeTableEntryCell);
    ...
    static TParseTree Block(TParseTree p)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.zeroOrMore!(BlankLine), pegged.peg.or!(BlockQuote, FootnoteDefinition, CodeBlock, Verbatim, Note, Reference, HorizontalRule, Heading, Table, PipeTable, DefinitionList, OrderedList, BulletList, HtmlBlock, StyleBlock, Para, pegged.peg.propagate!(Inlines))), "Markdown.Block")(p);
        }
        else
        {
    ...
    static TParseTree PipeTable(TParseTree p)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.and!(PipeTableHeader, PipeTableSeperator, pegged.peg.zeroOrMore!(PipeTableEntry)), "Markdown.PipeTable")(p);
        }
        else
        {
            if (auto m = tuple(`PipeTable`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(PipeTableHeader, PipeTableSeperator, pegged.peg.zeroOrMore!(PipeTableEntry)), "Markdown.PipeTable"), "PipeTable")(p);
                memo[tuple(`PipeTable`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree PipeTable(string s)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.and!(PipeTableHeader, PipeTableSeperator, pegged.peg.zeroOrMore!(PipeTableEntry)), "Markdown.PipeTable")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(PipeTableHeader, PipeTableSeperator, pegged.peg.zeroOrMore!(PipeTableEntry)), "Markdown.PipeTable"), "PipeTable")(TParseTree("", false,[], s));
        }
    }
    static string PipeTable(GetName g)
    {
        return "Markdown.PipeTable";
    }

    static TParseTree PipeTableHeader(TParseTree p)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(pegged.peg.literal!("|")), pegged.peg.zeroOrMore!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(Sp), PipeTableHeaderItem, pegged.peg.discard!(Sp)), pegged.peg.and!(pegged.peg.discard!(Sp), pegged.peg.discard!(pegged.peg.literal!("|")))))), pegged.peg.discard!(pegged.peg.literal!("|"))), pegged.peg.discard!(endOfLine)), "Markdown.PipeTableHeader")(p);
        }
        else
        {
            if (auto m = tuple(`PipeTableHeader`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(pegged.peg.literal!("|")), pegged.peg.zeroOrMore!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(Sp), PipeTableHeaderItem, pegged.peg.discard!(Sp)), pegged.peg.and!(pegged.peg.discard!(Sp), pegged.peg.discard!(pegged.peg.literal!("|")))))), pegged.peg.discard!(pegged.peg.literal!("|"))), pegged.peg.discard!(endOfLine)), "Markdown.PipeTableHeader"), "PipeTableHeader")(p);
                memo[tuple(`PipeTableHeader`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree PipeTableHeader(string s)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(pegged.peg.literal!("|")), pegged.peg.zeroOrMore!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(Sp), PipeTableHeaderItem, pegged.peg.discard!(Sp)), pegged.peg.and!(pegged.peg.discard!(Sp), pegged.peg.discard!(pegged.peg.literal!("|")))))), pegged.peg.discard!(pegged.peg.literal!("|"))), pegged.peg.discard!(endOfLine)), "Markdown.PipeTableHeader")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(pegged.peg.literal!("|")), pegged.peg.zeroOrMore!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(Sp), PipeTableHeaderItem, pegged.peg.discard!(Sp)), pegged.peg.and!(pegged.peg.discard!(Sp), pegged.peg.discard!(pegged.peg.literal!("|")))))), pegged.peg.discard!(pegged.peg.literal!("|"))), pegged.peg.discard!(endOfLine)), "Markdown.PipeTableHeader"), "PipeTableHeader")(TParseTree("", false,[], s));
        }
    }
    static string PipeTableHeader(GetName g)
    {
        return "Markdown.PipeTableHeader";
    }

    static TParseTree PipeTableHeaderItem(TParseTree p)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.fuse!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)), pegged.peg.zeroOrMore!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.literal!(" ")), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)))))), "Markdown.PipeTableHeaderItem")(p);
        }
        else
        {
            if (auto m = tuple(`PipeTableHeaderItem`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.fuse!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)), pegged.peg.zeroOrMore!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.literal!(" ")), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)))))), "Markdown.PipeTableHeaderItem"), "PipeTableHeaderItem")(p);
                memo[tuple(`PipeTableHeaderItem`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree PipeTableHeaderItem(string s)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.fuse!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)), pegged.peg.zeroOrMore!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.literal!(" ")), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)))))), "Markdown.PipeTableHeaderItem")(TParseTree("", false,[], s));
    ...
    static string PipeTableHeaderItem(GetName g)
    {
        return "Markdown.PipeTableHeaderItem";
    }

    static TParseTree PipeTableSeperator(TParseTree p)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.discard!(pegged.peg.and!(pegged.peg.literal!("|"), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.zeroOrMore!(pegged.peg.literal!("-")), pegged.peg.literal!("|"))), endOfLine)), "Markdown.PipeTableSeperator")(p);
        }
        else
        {
            if (auto m = tuple(`PipeTableSeperator`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.discard!(pegged.peg.and!(pegged.peg.literal!("|"), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.zeroOrMore!(pegged.peg.literal!("-")), pegged.peg.literal!("|"))), endOfLine)), "Markdown.PipeTableSeperator"), "PipeTableSeperator")(p);
                memo[tuple(`PipeTableSeperator`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree PipeTableSeperator(string s)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.discard!(pegged.peg.and!(pegged.peg.literal!("|"), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.zeroOrMore!(pegged.peg.literal!("-")), pegged.peg.literal!("|"))), endOfLine)), "Markdown.PipeTableSeperator")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.discard!(pegged.peg.and!(pegged.peg.literal!("|"), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.zeroOrMore!(pegged.peg.literal!("-")), pegged.peg.literal!("|"))), endOfLine)), "Markdown.PipeTableSeperator"), "PipeTableSeperator")(TParseTree("", false,[], s));
        }
    }
    static string PipeTableSeperator(GetName g)
    {
        return "Markdown.PipeTableSeperator";
    }

    static TParseTree PipeTableEntry(TParseTree p)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(pegged.peg.literal!("|")), pegged.peg.zeroOrMore!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(Sp), PipeTableEntryCell, pegged.peg.discard!(Sp)), pegged.peg.and!(pegged.peg.discard!(Sp), pegged.peg.discard!(pegged.peg.literal!("|")))))), pegged.peg.discard!(pegged.peg.literal!("|"))), pegged.peg.discard!(pegged.peg.option!(endOfLine))), "Markdown.PipeTableEntry")(p);
        }
        else
        {
            if (auto m = tuple(`PipeTableEntry`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(pegged.peg.literal!("|")), pegged.peg.zeroOrMore!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(Sp), PipeTableEntryCell, pegged.peg.discard!(Sp)), pegged.peg.and!(pegged.peg.discard!(Sp), pegged.peg.discard!(pegged.peg.literal!("|")))))), pegged.peg.discard!(pegged.peg.literal!("|"))), pegged.peg.discard!(pegged.peg.option!(endOfLine))), "Markdown.PipeTableEntry"), "PipeTableEntry")(p);
                memo[tuple(`PipeTableEntry`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree PipeTableEntry(string s)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(pegged.peg.literal!("|")), pegged.peg.zeroOrMore!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(Sp), PipeTableEntryCell, pegged.peg.discard!(Sp)), pegged.peg.and!(pegged.peg.discard!(Sp), pegged.peg.discard!(pegged.peg.literal!("|")))))), pegged.peg.discard!(pegged.peg.literal!("|"))), pegged.peg.discard!(pegged.peg.option!(endOfLine))), "Markdown.PipeTableEntry")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.and!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(pegged.peg.literal!("|")), pegged.peg.zeroOrMore!(pegged.peg.or!(pegged.peg.and!(pegged.peg.discard!(Sp), PipeTableEntryCell, pegged.peg.discard!(Sp)), pegged.peg.and!(pegged.peg.discard!(Sp), pegged.peg.discard!(pegged.peg.literal!("|")))))), pegged.peg.discard!(pegged.peg.literal!("|"))), pegged.peg.discard!(pegged.peg.option!(endOfLine))), "Markdown.PipeTableEntry"), "PipeTableEntry")(TParseTree("", false,[], s));
        }
    }
    static string PipeTableEntry(GetName g)
    {
        return "Markdown.PipeTableEntry";
    }

    static TParseTree PipeTableEntryCell(TParseTree p)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.fuse!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)), pegged.peg.zeroOrMore!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.literal!(" ")), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)))))), "Markdown.PipeTableEntryCell")(p);
        }
        else
        {
            if (auto m = tuple(`PipeTableEntryCell`, p.end) in memo)
                return *m;
            else
            {
                TParseTree result = hooked!(pegged.peg.defined!(pegged.peg.fuse!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)), pegged.peg.zeroOrMore!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.literal!(" ")), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)))))), "Markdown.PipeTableEntryCell"), "PipeTableEntryCell")(p);
                memo[tuple(`PipeTableEntryCell`, p.end)] = result;
                return result;
            }
        }
    }

    static TParseTree PipeTableEntryCell(string s)
    {
        if(false)
        {
            return         pegged.peg.defined!(pegged.peg.fuse!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)), pegged.peg.zeroOrMore!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.literal!(" ")), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)))))), "Markdown.PipeTableEntryCell")(TParseTree("", false,[], s));
        }
        else
        {
            forgetMemo();
            return hooked!(pegged.peg.defined!(pegged.peg.fuse!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)), pegged.peg.zeroOrMore!(pegged.peg.and!(pegged.peg.oneOrMore!(pegged.peg.literal!(" ")), pegged.peg.oneOrMore!(pegged.peg.and!(pegged.peg.negLookahead!(endOfLine), pegged.peg.negLookahead!(pegged.peg.literal!(" ")), pegged.peg.negLookahead!(pegged.peg.literal!("|")), pegged.peg.any)))))), "Markdown.PipeTableEntryCell"), "PipeTableEntryCell")(TParseTree("", false,[], s));
        }
    }
    static string PipeTableEntryCell(GetName g)
    {
        return "Markdown.PipeTableEntryCell";
    }
